...
for dataset in datasets:
    ...
    for i in range(20):
        ...
        model_base = torch.load('models/baseline_layernorms/baseline_model_tensorflow_layernorm1_iteration.pt',map_location=device) ## model 1 as the closest to mean refer to classification_all.ipynb
    ...
    #     "auc": auc
    # }
        filepath=f"base_line_tf/base_data_tensorflow_layernorm{dataset}.csv"
